...
export const LOCKED_PRODUCTS = [
  {
    ...
    plans: [
      { id: 'chatgpt-1m', duration: '١ مەهـ', price_iqd: 35000, price_usd: 25.0 },
    ],
  },
  {
    id: 'claude',
    ...
    deliveryType: 'instant',
    plans: [
      { id: 'claude-1m', duration: '١ مەهـ', price_iqd: 35000, price_usd: 25.0 },
    ],
  },
  {
    id: 'gemini',
    ...
    deliveryType: 'instant',
    plans: [
      { id: 'gemini-1m', duration: '١ مەهـ', price_iqd: 35000, price_usd: 25.0 },
    ],
  },
  {
    id: 'midjourney',
    ...
    deliveryType: 'instant',
    plans: [
      { id: 'midjourney-1m', duration: '١ مەهـ', price_iqd: 50000, price_usd: 37.0 },
    ],
  },
  {
    id: 'perplexity',
    ...
    deliveryType: 'instant',
    plans: [
      { id: 'perplexity-1m', duration: '١ مەهـ', price_iqd: 35000, price_usd: 25.0 },
    ],
  },
  {
    id: 'elevenlabs',
    ...
    deliveryType: 'instant',
    plans: [
      { id: 'elevenlabs-1m', duration: '١ مەهـ', price_iqd: usdToIqd(12), price_usd: 12.0 },
      { id: 'elevenlabs-1m-27', duration: '١ مەهـ', price_iqd: usdToIqd(30), price_usd: 30.0 },
  ...
  },
  {
    ...
    deliveryType: 'instant',
    plans: [
      { id: 'capcut-1m', duration: '١ مەهـ', price_iqd: usdToIqd(26), price_usd: 26.0 },
    ],
  },
  {
    id: 'paypal_acc',
  ...
  },
  {
    ...
    plans: [
      { id: 'spotify-1m', duration: '١ مەهـ', price_iqd: usdToIqd(6), price_usd: 6.0 },
    ],
  },
  {
    id: 'apple_music',
  ...
  },
  {
    ...
    deliveryType: 'instant',
    plans: [
      { id: 'youtube-1m', duration: '١ مەهـ', price_iqd: usdToIqd(7), price_usd: 7.0 },
    ],
  },
  {
    id: 'ps_plus',
    ...
    deliveryType: 'instant',
    plans: [
      { id: 'ps-ess-1m', duration: '(١ مەهـ) Essential', price_iqd: usdToIqd(18), price_usd: 18.0 },
    ],
  },
  {
    id: 'apple_gift_card',
    ...
    deliveryType: 'instant',
    plans: [
      { id: 'apple-gift-5', duration: '$5', price_iqd: usdToIqd(8), price_usd: 8.0 },
      { id: 'apple-gift-7', duration: '$7', price_iqd: usdToIqd(11), price_usd: 11.0 },
      { id: 'apple-gift-20', duration: '$20', price_iqd: usdToIqd(27), price_usd: 27.0 },
      { id: 'apple-gift-50', duration: '$50', price_iqd: usdToIqd(57), price_usd: 57.0 },
    ],
  },
  {
    id: 'apple-id-custom',
...
const PLAN_ID_ALIASES = {
  ...
  'spotify-1m': ['spotify_1m', 'spotify-3m', 'spotify_3m', 'spotify-12m', 'spotify_12m'],
  ...
  'youtube-1m': ['youtube_1m', 'youtube-3m', 'youtube_3m', 'youtube-12m', 'youtube_12m'],
