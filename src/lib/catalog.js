...
export const LOCKED_PRODUCTS = [
  ...
  },
  {
    ...
    deliveryType: 'instant',
    plans: [
      { id: 'elevenlabs-1m', duration: '١ مەهـ', price_iqd: 15000, price_usd: 10.0 },
      { id: 'elevenlabs-3m', duration: '٣ مەهـ', price_iqd: 70000, price_usd: 47.0 },
      { id: 'elevenlabs-12m', duration: '١٢ مەهـ', price_iqd: 240000, price_usd: 160.0 },
    ],
  },
  {
    id: 'kling',
    ...
    deliveryType: 'instant',
    plans: [
      { id: 'kling-1m', duration: '١ مەهـ', price_iqd: 27500, price_usd: 18.0 },
      { id: 'kling-3m', duration: '٣ مەهـ', price_iqd: 55000, price_usd: 37.0 },
      { id: 'kling-12m', duration: '١٢ مەهـ', price_iqd: 190000, price_usd: 127.0 },
    ],
  },
  {
    id: 'canva',
    ...
    orderType: 'telegram',
    plans: [
      { id: 'canva-1y', duration: '١ ساڵ (تایبەت)', price_iqd: 27500, price_usd: 18.0 },
    ],
    telegramMessage: 'سلاڤ، من دڤێت ئیشتراکا Canva Pro (١ ساڵ) بکڕم.',
  },
  {
    id: 'capcut',
    name: 'CapCut Pro',
    ...
    deliveryType: 'instant',
    plans: [
      { id: 'capcut-1m', duration: '١ مەهـ', price_iqd: 35000, price_usd: 23.0 },
      { id: 'capcut-3m', duration: '٣ مەهـ', price_iqd: 40000, price_usd: 27.0 },
      { id: 'capcut-12m', duration: '١٢ مەهـ', price_iqd: 140000, price_usd: 93.0 },
    ],
  },
  {
    id: 'paypal_acc',
    ...
    comingSoon: true,
    plans: [
      { id: 'paypal-acc-1', duration: 'هەژمارێکی پشتڕاستکری', price_iqd: 20000, price_usd: 14.0 },
    ],
  ...
  },
  {
    ...
    deliveryType: 'instant',
    plans: [
      { id: 'shahid-1m', duration: '١ مەهـ', price_iqd: 10500, price_usd: 7.0 },
      { id: 'shahid-12m', duration: '١٢ مەهـ', price_iqd: 120000, price_usd: 80.0 },
    ],
  },
  {
    id: 'spotify',
  ...
  },
  {
    ...
    deliveryType: 'instant',
    plans: [
      { id: 'apple-music-1m', duration: '١ مەهـ', price_iqd: 23000, price_usd: 15.0 },
      { id: 'apple-music-12m', duration: '١٢ مەهـ', price_iqd: 65000, price_usd: 43.0 },
    ],
  },
  {
    id: 'youtube_music',
...
const PLAN_ID_ALIASES = {
  ...
  'canva-1y': ['canva-1m', 'canva_1m', 'canva-12m', 'canva_12m'],
  'capcut-1m': ['capcut_1m'],
  'capcut-3m': ['capcut_3m'],
  'capcut-12m': ['capcut_12m'],
  ...
  'elevenlabs-3m': ['elevenlabs_3m'],
  'elevenlabs-12m': ['elevenlabs_12m'],
  'kling-1m': ['kling_1m'],
  'kling-3m': ['kling_3m'],
  'kling-12m': ['kling_12m'],
  'shahid-1m': ['shahid_1m'],
  'shahid-12m': ['shahid_12m'],
  'apple-music-1m': ['apple_music_1m'],
  'apple-music-12m': ['apple_music_12m'],
