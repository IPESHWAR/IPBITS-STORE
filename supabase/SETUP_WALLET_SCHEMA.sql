-- Run this in the Supabase SQL Editor to align the live database
-- with profiles / vouchers / transactions. Safe to re-run.
-- Same contents as supabase/migrations/004_profiles_vouchers_transactions.sql
